  ...
  <div class="configurator-wrapper">
    <v-card-text class="configurator-size">
      ...
      <v-select
        rounded="lg"
        v-model="size"
        :items="drinkOptions.map(option => option.size)"
        label="Выберите размер"
      ></v-select>

      <v-img
        v-if="size === 'standard'"
        src="@/assets/standard-coffee-machine.png"
        alt="Стандартная кофемашина"
        height="100"
        width="100"
      ></v-img>
      ...
      <v-img
        ...
        src="@/assets/large-coffee-machine.png"
        alt="Увеличенная кофемашина"
        height="100"
        width="100"
      ></v-img>
      <v-img
        v-else-if="size === 'veryLarge'"
        src="@/assets/very-coffee-machine.png"
        alt="Огромная кофемашина"
        height="100"
        width="100"
      ></v-img>
    </v-card-text>
    ...
    <v-card-text class="configurator-drink-count">
      ...
      <v-select
        rounded="lg"
        v-model="drinkCount"
        :items="drinkOptions.map(option => option.drinkCount)"
